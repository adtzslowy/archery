    ...
    <div class="mx-auto space-y-6">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-muted-foreground">
                Register a new archer into the system.
            </p>
        </div>
        ...
        <x-ui.card>
            ...
            <form method="POST" action="{{ route('partisipan.store') }}">
                @csrf
                ...
                <x-ui.card-header>
                    ...
                    <p class="text-sm text-muted-foreground">
                        Fill in the participant's information below.
                    </p>
                </x-ui.card-header>
                ...
                <x-ui.card-content class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <label for="participant_number" class="text-sm font-medium">
                            Participant Number
                        </label>

                        <x-ui.input id="participant_number" name="participant_number"
                            value="{{ old('participant_number') }}" placeholder="e.g. P001" required />
                    ...
                    <div class="space-y-2">
                        ...
                        <x-ui.input id="birth_date" type="date" name="birth_date" value="{{ old('birth_date') }}" />
