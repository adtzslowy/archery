...
@section('content')
    ...
    <div class="space-y-6">
        ...
        {{-- Flash Messages --}}
        @if (session('success'))
            <div class="flex items-start gap-3 rounded-lg border border-green-500/20 bg-green-500/10 px-4 py-3 text-sm">
        ...
        @if (session('error'))
            <div class="flex items-start gap-3 rounded-lg border border-destructive/20 bg-destructive/10 px-4 py-3 text-sm">
                                ...
                                <tr class="transition-colors hover:bg-muted/30">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="flex justify-end gap-1">
                                            ...
                                            {{-- Edit Lane --}}
                                            <button type="button"
                                                onclick="document.getElementById('edit-lane-{{ $participant->id }}').classList.toggle('hidden')"
                    ...
                    <div class="grid gap-6 sm:grid-cols-3">
                        ...
                        <div class="space-y-2">
                            ...
                            <x-ui.input id="ends" name="ends" type="number" min="1"
                                value="{{ old('ends', $match->setting?->ends ?? 6) }}" placeholder="6" />
