                    ...
                    <article
                        ...
                        <div class="flex items-start justify-between gap-5">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <h3 class="mt-2 text-xl font-bold text-zinc-950">
                        ...
                        <div class="mt-8 space-y-3 border-t border-zinc-100 pt-6">
                            ...
                            <div class="flex items-center justify-between gap-4 text-sm">
                                ...
                                <span class="text-right font-medium text-zinc-700">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid grid-cols-2 gap-3 sm:mt-16 sm:h-[720px] sm:grid-cols-4 sm:grid-rows-2 sm:gap-4">
                ...
                <div
                    ...
                    <img src="{{ asset('images/hero/hero-1.jpeg') }}" alt="Archery Gallery"
                ...
                <div class="aspect-square overflow-hidden rounded-2xl bg-zinc-100 sm:aspect-auto">
                    ...
                    <img src="{{ asset('images/hero/hero-2.jpeg') }}" alt="Archery Gallery"
                        class="h-full w-full object-cover transition duration-700 hover:scale-105">
                ...
                <div class="aspect-square overflow-hidden rounded-2xl bg-zinc-100 sm:aspect-auto">
                    ...
                    <img src="{{ asset('images/hero/hero-3.jpeg') }}" alt="Archery Gallery"
                        class="h-full w-full object-cover transition duration-700 hover:scale-105">
                ...
                <div class="mt-10 flex flex-wrap gap-2 sm:mt-12">
                    ...
                    @foreach ($categories as $category)
                        <a href="#category-{{ $category->id }}"
                            class="rounded-xl border border-white/10 bg-white/[0.04] px-4 py-2.5 text-sm font-semibold text-zinc-400 transition hover:border-white/30 hover:bg-white hover:text-zinc-950 sm:px-5 sm:py-3">
        ...
        ====================================================== --}}
            ...
            @forelse ($categories as $category)
                ...
                <div id="category-{{ $category->id }}"
                    class="mt-10 scroll-mt-24 rounded-3xl border border-white/10 bg-white/[0.03] p-5 sm:mt-12 sm:p-8 lg:p-10">
                    ...
                    <div
                        ...
                        <div
                            class="inline-flex w-fit rounded-full border border-white/10 px-4 py-2 text-xs text-zinc-400">
                        ...
                        <div class="mt-8 grid gap-6 lg:grid-cols-2">
                            ...
                            @foreach ($categoryMatches as $match)
                                ...
                                <article
                                    ...
                                    @if ($match->participants->isNotEmpty())
                                        <div class="mt-5 space-y-2">
                                            ...
                                            @foreach ($match->participants as $participant)
                                                ...
                                                <div
                                                    class="flex items-center justify-between gap-4 rounded-xl border border-white/10 bg-white/[0.03] p-4">
                                    ...
                                    <div
                                        class="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-white/10 pt-4 text-xs text-zinc-500">
                    ...
                    @else
                        <div class="mt-8 rounded-2xl border border-dashed border-white/10 p-10 text-center">
            ...
            @empty
                ...
                <div
                    class="mt-10 rounded-3xl border border-dashed border-white/10 bg-white/[0.02] p-12 text-center sm:mt-12">

                    <div class="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-white/5">

                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-zinc-600" fill="none"
