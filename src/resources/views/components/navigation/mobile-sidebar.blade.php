<aside class="fixed inset-y-0 left-0 z-50 w-64 transform -translate-x-full transition-transform duration-300 ease-in-out bg-background shadow-xl lg:hidden" :class="mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'" @keydown.escape.window="mobileMenuOpen = false">
    {{-- =========================================================
        LOGO / BRAND
    ========================================================== --}}
    ...
    <div class="flex h-16 items-center justify-between border-b px-6">
        ...
        <button type="button" @click="mobileMenuOpen = false" class="inline-flex size-8 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground">
